...
SECRET_KEY = 'django-insecure-&^!kh5nh6box1^zzi^dn^#s=&26(u37(pm+2%1$j+%*(-_^5$j'
...
AUTHENTICATION_BACKENDS = [
    ...
    'django.contrib.auth.backends.ModelBackend'   # not really needed because we check for username and email or username it's a safer to have it
]
