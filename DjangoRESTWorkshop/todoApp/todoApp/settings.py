...
SECRET_KEY = 'django-insecure-e2-$^z&&y9xm(&_qwn$ljx59)$fryb%t%#jm!ru)#g&g_w#2m0'
...
INSTALLED_APPS = [
    ...
    'rest_framework_simplejwt',  # pip install pip freezedjangorestframework-simplejwt
    'rest_framework_simplejwt.token_blacklist',

] + PROJECT_APPS

# accessToken -> used to Log In, 5, 10, 15 min
# refreshToken -> used to get new accessToken -> 1day 1week
